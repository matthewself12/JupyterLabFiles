...
class TempTest(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "TempTest")
        ...
        self.qtgui_time_sink_x_0.set_y_axis(0, 0.005)
        ...
        labels = ['Magnitude^2', 'Signal', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/selfboy3/Documents/data', True, 0, 0)
...
def main(top_block_cls=TempTest, options=None):
